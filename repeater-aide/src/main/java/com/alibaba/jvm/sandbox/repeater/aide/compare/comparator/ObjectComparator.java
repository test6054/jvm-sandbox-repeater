...
public class ObjectComparator implements Comparator {
    ...
    @Override
    public void compare(Object left, Object right, List<Path> paths, IntegratedComparator comparator, List<String> excludeField) {
        ...
        innerCompare(lCs, left, right, paths, comparator, excludeField);
    }
     ...
     */
    private void innerCompare(Class<?> clazz, Object left, Object right, List<Path> paths, IntegratedComparator comparator, List<String> excludeField) {
        ...
        for (Field field : fields) {
            ...
            try {
                ...
                comparator.dispatch(field.get(left), field.get(right), comparator.declarePath(paths, field.getName()),excludeField);
            } catch (Exception e) {
                // this may not happen
        ...
        while (superClazz != null && superClazz != Object.class) {
            innerCompare(superClazz, left, right, paths, comparator,excludeField);
