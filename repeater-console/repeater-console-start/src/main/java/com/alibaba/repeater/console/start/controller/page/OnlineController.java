...
public class OnlineController {
    ...
    @ResponseBody
    public RepeaterResult<PageResult<RecordBO>> queryList(RecordParams params){
        PageResult<RecordBO> data = recordService.query(params);
        RepeaterResult result = new RepeaterResult();
        result.setData(data);
        return result;
    }
}
