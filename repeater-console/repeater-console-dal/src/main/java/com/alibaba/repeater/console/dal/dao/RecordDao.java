...
public class RecordDao {
    ...
    public List<Record> selectByAppNameAndTraceIdList(String appName, List<String> traceIdList) {
        return recordRepository.findByAppNameAndTraceIdList(appName, traceIdList);
    }

    public List<Record> selectByTotalNumList(Integer total) {
        Pageable pageable = new PageRequest(0, total -1, new Sort(Sort.Direction.DESC,"id"));
