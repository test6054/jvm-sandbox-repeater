...
public class RepeaterConfig implements java.io.Serializable{
     ...
     * 配置接口采样率
     */
    private List<ApiSampleRate> apiSampleRate = Lists.newArrayList();

    /**
     * 黑名单过滤
     */
    private List<String> blackEntrancePatterns  = Lists.newArrayList();
    ...
    public List<ApiSampleRate> getApiSampleRate() {
        return apiSampleRate;
    }

    public void setApiSampleRate(List<ApiSampleRate> apiSampleRate) {
        this.apiSampleRate = apiSampleRate;
    }

    public List<String> getBlackEntrancePatterns() {
        return blackEntrancePatterns;
    }

    public void setBlackEntrancePatterns(List<String> blackEntrancePatterns) {
        this.blackEntrancePatterns = blackEntrancePatterns;
    }

    public Map<String, Integer> getApiSampleRateResult() {
        Map<String, Integer> apiSampleRate = new HashMap<String, Integer>();
        for (ApiSampleRate sampleRate : this.apiSampleRate) {
            apiSampleRate.put(sampleRate.getReqUri(),sampleRate.getSampleRate());
        }
        return apiSampleRate;
    }
}