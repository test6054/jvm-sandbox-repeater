...
public class TraceGenerator {
    ...
    private static String BATCH_FLAG = "BA";

    private static String TRACE_FLAG = "TR";

    public static String generate() {
        StringBuilder builder = new StringBuilder(32);
        builder.append(TRACE_FLAG)
    ...
    public static boolean isValid(String traceId) {
        ...
        if (traceId.length() != 32 && !traceId.startsWith(TRACE_FLAG)) {
            return false;
        }
        return NumberUtils.isDigits(traceId.substring(27, 32));
    }
    ...
    static String getSampleBit(String traceId) {
        return isValid(traceId) ? traceId.substring(27, 32) : "9999";
    }

    public static String generateBatch() {
        StringBuilder builder = new StringBuilder(32);
        builder.append(BATCH_FLAG)
                .append(IP_COMPLETION)
                .append(System.currentTimeMillis())
                .append(getNext());
        return builder.toString();
